...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO students (first_name, last_name, achievements, about, image) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([$first_name, $last_name, $achievements, $about, $image]);
    ...
    <div class="add-block">
        <div>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                О студенте:<br> <textarea name="about" required></textarea><br>
